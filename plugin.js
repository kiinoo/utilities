...
(function () {
        ...
        Object.extend(StockSuggest.prototype, {
                initialize: function (obj, arg) {
                    ...
                    this.text = Gee.isNullorEmpty(arg.text) ? "������..." : arg.text;
                    this.header = Gee.isNullorEmpty(arg.header) ? ["ѡ��", "����", "����"] : arg.header;
                        ...
                        if (("key_" + _s) in this._Y && this._Y["key_" + _s] != "") {
                            ...
                            if (this.header != null) {
                                for (var i = 0; i < this.header.length; i++) {
                                    var _t_th = Gee.$C("th");
                                    if (this.header[i] == "����") _t_th.width = 52;
                                    if (this.header[i] == "����") _t_th.width = 40;
